...
const UUID = process.env.UUID || '32c8b103-f454-4800-8c2f-75a37u252210';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nzfd.133088.xyz:80';         // 哪吒面板地址,v1形式：nz.serv00.net:8008  v0形式：nz.serv00.net
const NEZHA_PORT = process.env.NEZHA_PORT || '';             // v1哪吒请留空，v0 agent端口，当端口为{443,8443,2087,2083,2053,2096}时，自动开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'rEU8jxTTZAExyrWBzkNrqFCGo0CeA3QD';               // v1的NZ_CLIENT_SECRET或v0 agwnt密钥 
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'go-sg.xxxo.qzz.io';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNTA0NmI1ODdjNmU0YmRhN2FlNTM2ZGZjZGVjM2M1NDkiLCJ0IjoiMTBhYWY2NWMtYzNmNS00YWRjLWEzYTMtZTQ4M2UyZDlkOTNjIiwicyI6IlkyWXlNV0l3WTJNdE1HVmlPUzAwTkRCaExXSTNZemt0TnpWaVl6bGxNRFUwT1RRMSJ9';               // argo固定隧道token或json,留空即使用临时隧道
...
const HY2_PORT = process.env.HY2_PORT || '6789';                 // hy2端口，支持多端口的可以填写，否则留空
